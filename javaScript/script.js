const cardCVC = document.querySelector(".dummy-cvc");
const cardNumber = document.querySelector(".dummy-number");
const cardName = document.querySelector(".dummy-name");
const cardExpDate = document.querySelector(".dummy-exp");
...
const inputCVC = document.querySelector(".cvc-back");
